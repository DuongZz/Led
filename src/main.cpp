...
int currentState;
const char *ssid = "WangZuong";
const char *password = "31603002";
String command_t = ""; // Command received from Android device
...
void loop()
{
  ...
  String command_t = checkClient();
  if (command_t != "")
  {
    currentEffect = command_t;
